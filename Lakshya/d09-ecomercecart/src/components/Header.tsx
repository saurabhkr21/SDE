...
export default function Header() {
    ...
    return (
        <div
            className="flex w-full bg-[#131921] text-white  justify-between gap-1  items-center p-2">
            ...
            <div className="flex w-[140px] h-[40px] p-0.5 hover:border-white border border-transparent">
                <span className="flex items-end justify-center">
                    ...
                    src="https://img.icons8.com/fluency-systems-regular/FFFFFF/marker--v1.png" alt="marker--v1" /></span>
            ...
            <div className="flex flex-1 relative border rounded h-10 overflow-hidden group z-[4] outline-2 group-has-[input:active]:outline-[#FF9900] text-black">
                <form action="/search" method="GET"
                    ...
                    <input type="text" value={userInput} onChange={handleClick}
                        className="flex-1 bg-white p-1" name="q" placeholder='Search ECOCart.in' />
            ...
            <div className="flex gap-1">
                <Link href="/login">
                    <button
                        className="w-15 hover:border-white  border-transparent text-md  text-white rounded-md h-10 border">
                        Login
                    </button>
                </Link>
                <Link href="/cart">
                    <button
                        className="flex w-15 text-md hover:border-white  border-transparent text-white rounded-md h-10 border items-center justify-center">
                        <img width="24" height="24" src="https://img.icons8.com/material-outlined/FFFFFF/shopping-cart.png" alt="shopping-cart" />
                    </button></Link>
            </div>
        </div>
    )
