...
const ProductCard = ({ item }) => {
    ...
    const [activeImage, setActiveImage] = useState(item.thumbnail || item.images?.[0]);
        ...
        <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden max-w-sm">
            ...
            <div className="relative group">
                ...
                <div className="flex gap-2 mt-3 overflow-x-auto">
                    {item.images?.map((img, idx) => (
                        <div key={idx} className="w-12 h-12 rounded border cursor-pointer overflow-hidden">
                            <Image
                                src={img}
                                alt={`thumb-${idx}`}
                                width={48}
            ...
            <div className="p-4">
                ...
                <div className="flex items-center justify-between mb-3">
                    ...
                    <div className={`text-sm ${item.stock ? 'text-green-600' : 'text-red-600'}`}>
